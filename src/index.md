...
<div style="max-width: 1400px; margin: 40px auto; padding: 0 24px; font-family: 'Helvetica Neue', Arial, sans-serif; display: grid; grid-template-columns: 220px 1fr 220px; gap:25px;">
  ...
  <!-- 🟦 KALIWANG KAHON / MGA LINK NG BALITA -->
  <div>
    <div style="background: linear-gradient(180deg, #00467f, #2a6fb8); border-radius:12px; padding:20px; color:white; box-shadow: 0 4px 15px rgba(0,70,127,0.2); margin-bottom: 25px;">
      ...
      <ul style="list-style: none; padding: 0; margin: 15px 0 0 0;">
        <li style="margin-bottom: 10px;">
          <a href="https://www.philstar.com/" target="_blank" style="color: white; text-decoration: none; font-size: 0.95em; line-height: 1.6; opacity: 0.9; transition: opacity 0.3s;">
            ✅ Philstar
          </a>
        </li>
        <li style="margin-bottom: 10px;">
          <a href="https://mb.com.ph/" target="_blank" style="color: white; text-decoration: none; font-size: 0.95em; line-height: 1.6; opacity: 0.9; transition: opacity 0.3s;">
            ✅ Manila Bulletin
          </a>
        </li>
        <li style="margin-bottom: 10px;">
          <a href="https://www.pna.gov.ph/" target="_blank" style="color: white; text-decoration: none; font-size: 0.95em; line-height: 1.6; opacity: 0.9; transition: opacity 0.3s;">
            ✅ PNA (Gobyerno)
          </a>
        </li>
        <li>
          <a href="https://www.rappler.com/" target="_blank" style="color: white; text-decoration: none; font-size: 0.95em; line-height: 1.6; opacity: 0.9; transition: opacity 0.3s;">
            ✅ Rappler
          </a>
        </li>
      </ul>
    ...
    <div style="background: #f8fafc; border:2px solid #e2e8f0; border-radius:12px; padding:20px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      ...
      <p style="font-size:0.9em; line-height:1.5; background:#e6f0f8; padding:10px; border-radius:6px; color: #00467f;">
        Ang mga nilalaman ay mula sa mga opisyal na pinagkukunan. Para sa karagdagang detalye, pindutin ang pamagat ng balita.
      </p>
    </div>
  </div>


  <!-- 📰 GITNA: PANGUNAHING BALITA (napanatili ang lahat ng dati mong ayos!) -->
  <div>
  ...
  <!-- 🟩 KANANG KAHON / MGA LINK NG ARTIKULO -->
  <div>
    <div style="background: #f8fafc; border:2px solid #e2e8f0; border-radius:12px; padding:20px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); margin-bottom: 25px;">
      ...
      <ul style="list-style:none; padding:0; margin:15px 0;">
        <li style="padding:6px 0; border-bottom:1px dashed #cbd5e1;">
          <a href="#" style="color: #00467f; text-decoration: none; font-weight: bold; transition: color 0.3s;">
            ✅ Pambansang Balita
          </a>
        </li>
        <li style="padding:6px 0; border-bottom:1px dashed #cbd5e1;">
        ...
        <li style="padding:6px 0; border-bottom:1px dashed #cbd5e1;">
          <a href="#" style="color: #00467f; text-decoration: none; font-weight: bold; transition: color 0.3s;">
            💼 Kabuhayan at Negosyo
          </a>
        </li>
        <li style="padding:6px 0;">
          <a href="#" style="color: #00467f; text-decoration: none; font-weight: bold; transition: color 0.3s;">
            📰 Iba pang Napapanahong Isyu
          </a>
        </li>
      </ul>
    </div>
    ...
    <div style="background: linear-gradient(180deg, #00467f, #2a6fb8); border-radius:12px; padding:20px; color:white; box-shadow: 0 4px 15px rgba(0,70,127,0.2);">
      ...
      <div style="background:#ffffff20; padding:12px; border-radius:6px; text-align:center; font-weight:bold; color:#fff; margin-top: 15px;">
        {{ "now" | date:"%B %d, %Y" }}
      </div>
    </div>
  </div>
